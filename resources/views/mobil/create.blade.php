    ...
    <div class="card-body">
        <form action="{{ route('mobil.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('jenis_bahan_bakar') is-invalid @enderror" id="jenis_bahan_bakar" name="jenis_bahan_bakar" value="{{ old('jenis_bahan_bakar') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('kapasitas_mobil') is-invalid @enderror" id="kapasitas_mobil" name="kapasitas_mobil" value="{{ old('kapasitas_mobil') }}" min="1" max="20" required>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('tarif_sewa_per_hari') is-invalid @enderror" id="tarif_sewa_per_hari" name="tarif_sewa_per_hari" value="{{ old('tarif_sewa_per_hari') }}" min="50000" required>
